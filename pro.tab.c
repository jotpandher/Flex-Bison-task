...
{
  "$end", "error", "$undefined", "srnum", "xnodes", "ynodes", "znodes",
  "beamx", "beamy", "$accept", "FELT", YY_NULLPTR
};
#endif
...
#line 1299 "pro.tab.c" /* yacc.c:1646  */
      default: break;
    }
